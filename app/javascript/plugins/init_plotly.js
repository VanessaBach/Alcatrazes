...
const plotMxwvht = (almirantadointData, almirantadoextData, inpeData) => {

    const almirantadointMxwvht = {
      x: almirantadointData.date_time,
      y: almirantadointData.mxwvht,
      mode: 'lines+markers',
      name: 'almirantado_int',
      line: {
        color: '#c22d45',
    ...
    const almirantadoextMxwvht = {
      x: almirantadoextData.date_time,
      y: almirantadoextData.mxwvht,
      mode: 'lines+markers',
      name: 'almirantado_ext',
      line: {
        color: '#2f42ad',
    ...
    const data = [almirantadointMxwvht, almirantadoextMxwvht, inpeMxwvht];
